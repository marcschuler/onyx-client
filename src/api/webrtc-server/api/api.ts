...
export const APIS = [ChannelControllerService, ChatControllerService, GroupControllerService, InfoControllerService, PolicyControllerService, SectionControllerService, ServerControllerService, StorageControllerService, TodoControllerService, UserControllerService];
