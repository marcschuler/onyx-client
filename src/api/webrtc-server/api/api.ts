...
export const APIS = [ChannelControllerService, ChatControllerService, GroupControllerService, InfoControllerService, SectionControllerService, ServerControllerService, ServerDescriptionControllerService, StorageControllerService, TodoControllerService, UserControllerService];
